# 1DT106 Lecture 4: Specification

This repository holds the slides for the forth lecture in 1DT106 Programming
...
```bash 
git clone --recursive https://github.com/uu-1dt106/lecture4_specification.git 
```
